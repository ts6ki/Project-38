...
var END = 0;
var gameState = PLAY;
var gameOver, restart, gameOverButton, restartButton;
...
function preload(){
  ...
  obstacle2 = loadImage("spikes1.png");
...
function draw() {
  ...
  camera.position.y=trex.y -25;

  text("Score: "+ score, trex.x + 450, trex.y - 75);
